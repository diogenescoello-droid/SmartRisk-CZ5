...
const gatePosition = index.indexOf("access-gate.js?v=11.0.0-rc16.7");
...
ok(rollout.includes('BUILD_VERSION = "11.0.0-rc17-operativo-p0"'), "RC13 preservada bajo la caché operativa P0");
