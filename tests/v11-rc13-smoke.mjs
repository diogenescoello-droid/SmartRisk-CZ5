...
const rolloutPosition = index.indexOf("v11-rollout.js?v=11.0.0-rc16.6");
const menuPosition = index.indexOf("rc13-menu.js?v=1.0.0-piloto-estable");
const gatePosition = index.indexOf("access-gate.js?v=11.0.0-rc16.6");
...
ok(rollout.includes('BUILD_VERSION = "11.0.0-rc16.6"'), "RC13 preservada bajo la caché vigente RC15");
