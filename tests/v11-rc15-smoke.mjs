...
const checks = [
  ...
  ["Caché del index actualizada", index.includes("v11-rollout.js?v=11.0.0-rc17-operativo-p0")],
  ...
  ["Formulario Kobo de sitios conectado como contingencia transitoria", script.includes("https://ee.kobotoolbox.org/x/aEcQSdRP")],
  ["Formulario Kobo F07 conectado como contingencia transitoria", script.includes("https://ee.kobotoolbox.org/x/0pXtskTZ")],
  ...
  ["RC15 no introduce escrituras Firestore directas", !/firestore\(\)|\.collection\(|setDoc|addDoc|updateDoc|deleteDoc|writeBatch/.test(script)]
];
...
console.log("\nTodas las pruebas RC15 pasaron sobre P0.");
