...
const checks = [
  ...
  ["Caché del index actualizada", index.includes("v11-rollout.js?v=11.0.0-rc15")],
  ...
  ["Archivos RC15 incluidos en publicación", assets.files.includes("v11-mobile-rc15.css") && assets.files.includes("v11-mobile-rc15.js")],
