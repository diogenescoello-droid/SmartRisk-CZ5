...
assert.match(ui,/Registros con monto/);
assert.match(ui,/Actividades reportadas en F07/);
assert.match(ui,/reportedBudgetUsd/);
...
assert.match(index,/enos-matrix\.css\?v=2026\.08\.22\.4/);
