...
assert.match(index,/access-gate\.js\?v=2026\.08\.31\.5-direct-credentials/);
console.log("PASS transición sin exposición de la interfaz anterior y acceso directo por credencial");
