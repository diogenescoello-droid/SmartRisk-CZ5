window.SR_ECUADOR_TERRITORIES = {
  source:'INEC - Clasificador Geográfico Estadístico / actualización legal Sevilla Don Bosco',
  updated:'2026-08-13',
  provinces:{
    ...
    'Guayas':['Guayaquil','Alfredo Baquerizo Moreno (Jujan)','Balao','Balzar','Colimes','Daule','Durán','El Empalme','El Triunfo','Milagro','Naranjal','Naranjito','Palestina','Pedro Carbo','Samborondón','Santa Lucía','Salitre (Urbina Jado)','San Jacinto de Yaguachi','General Villamil (Playas)','Simón Bolívar','Coronel Marcelino Maridueña','Lomas de Sargentillo','Nobol','General Antonio Elizalde (Bucay)','Isidro Ayora'],
    ...
    'Morona Santiago':['Morona','Gualaquiza','Limón Indanza','Palora','Santiago','Sucúa','Huamboya','San Juan Bosco','Taisha','Logroño','Pablo Sexto','Tiwintza','Sevilla Don Bosco'],
    'Napo':['Tena','Archidona','El Chaco','Quijos','Carlos Julio Arosemena Tola'],
    'Orellana':['Francisco de Orellana','Aguarico','La Joya de los Sachas','Loreto'],
    'Pastaza':['Pastaza','Mera','Santa Clara','Arajuno'],
    'Pichincha':['Distrito Metropolitano de Quito','Cayambe','Mejía','Pedro Moncayo','Rumiñahui','San Miguel de los Bancos','Pedro Vicente Maldonado','Puerto Quito'],
