(() => {
  ...
  function install(){
    ...
    matrix.gads.forEach(gad=>{
      ...
      gad.validationState=`${gad.institutionalStatus || "ESTADO POR CONFIRMAR"} · AUDITADO 22-AGO-2026`;
    });
    if(!api.__audit20260822Wrapped){
      ...
      api.contextFor=gad=>{
        ...
        return gad?.auditFinding ? {...context,conclusion:gad.auditFinding} : context;
      };
